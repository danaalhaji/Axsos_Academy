...
</svg>Edit ${editProject.title}  !</h1>
<p style="margin-top:10px;"><p style="margin-top:10px;"><c:if test="${project.projectAdmin.id == logged.id}"><a href="/project/${project.id}/delete">Delete</a></c:if>  |    <a href="/home">Back To Dashboard</a></p>
</div>
<div style = "width: 70%; margin: 0 auto;">
<form:form action="/project/submitedit/${editProject.id}" method="post" modelAttribute="editProject">
